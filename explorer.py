...
def compute_loss(model, loss_weights, init_image, gram_style_features, content_features, num_style_layers):
...
def run_style_transfer(content_img,
    ...
    style_features, content_features = get_feature_representations(
        model, content_img, style_img, num_style_layers)
...
if __name__ == "__main__":
    ...
    style_layers = [layer for layer, selected in zip(
        ALL_STYLE_LAYERES, style_selections) if selected]
